...
public function index(){
  //Pesquisar por solecitacao 
   ...
   public function store(Request $request){ 
      ...
      // $query='select email from cliente where id=2';
      // $endereco=DB::select($query);
      //   $to_name='Abertura de Chamado';

      //   $to_mail="anisio.bule@gmail.com";
      //   $data=array('name'=>'anisio','body'=>"Foiaberta uma solicitacao para o seu pedido de reparacao de equipamento");
      //   Mail::send('formularios.email',$data,function($massage) use ($to_name,$to_mail){
      //       $massage->to($to_mail)
      //       ->subject('Seu pedido foi aberto');
      //   });
      //   echo "email enviado";
