                            ...
                            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    ...
                                    <form action="<?php echo e(action('requis_Controller@store','/pesquisar')); ?>" name="RequisForm" method="POST">
                                        ...
                                        <div class="modal-body">
                                              ...
                                              <fieldset hidden="true">
                                                <div class="form-group">
                                                    ...
                                                    <select name="idsolec" class="form-control">
                                                        <option value="<?php echo e($st->id); ?>"><?php echo e($st->id); ?></option>
                                                    </select>
                                                </div>
                                                </fieldset>
                                             ...
                                             <div class="form-group input-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::text('desc',null,['class'=>'form-control', 'placeholder'=>'']); ?> 
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::text('quant',null,['class'=>'form-control', 'placeholder'=>'']); ?> 
                                                </div>
                                              ...
                                              <div class="form-group  col-lg-12">
                                                ...
                                                <div class="form-group">
                                                     <label for="enabledSelect">Tipo de Iten</label>  
                                                       <?php echo Form::select('tipo',['placeholder'=>'selecionar'],null,['class'=>'form-control','id'=>'ftipo']); ?>

                                                </div>

                                                <div class="form-group">
                                                     <label for="enabledSelect">Part Number</label>  
                                                       <?php echo Form::select('partnumber',['placeholder'=>'selecionar '],null,['class'=>'form-control','id'=>'fpart']); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo Form::text('desc',null,['class'=>'form-control', 'placeholder'=>'','id'=>'fdesc']); ?> 
                                                </div>
