                                ...
                                <div class="panel-body">
                                    <form>
                                        ...
                                        <table class="display nowrap" style="width:100%" id="req_peden">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $req_abate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <?php echo link_to_route('abate_requisicao.show',$title='',$parameters=$ass->id,$attributes=['data-toggle'=>'tooltip', 'title'=>'Stock Requisitado','class'=>'btn btn-outline btn-info fa fa-list-alt btn-sm']); ?>
