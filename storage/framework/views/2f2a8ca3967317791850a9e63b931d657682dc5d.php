                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo e($solec_abertas); ?></div>
            ...
            <div class="panel panel-yellow">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"> <?php echo e($equipamento); ?></div>
            ...
            <div class="panel panel-red">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo e($peg_pedent); ?></div>
                            <div>Pedentes!</div>
                        </div>
                    </div>
                </div>
...
<!-- /#page-wrapper -->
                    <!--      <div id="chart_div"></div>             CHARTS DA GOOGLE--> 
