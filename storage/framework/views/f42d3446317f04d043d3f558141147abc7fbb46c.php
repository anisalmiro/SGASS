...
<html>
    <head>
        ...
        <?php echo Html::style('css/font-awesome/select.dataTables.min.css'); ?>

        <?php echo Html::style('css/editor.dataTables.min.css'); ?>

        <?php echo Html::style('css/jquery.dataTables.min.css'); ?>

        <?php echo Html::style('css/buttons.dataTables.min.css'); ?>

        <?php echo Html::style('css/select.dataTables.min.css'); ?>
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <?php echo Auth::user()->nameapelido; ?><!--Usuario-->
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="fa fa-stack-overflow" href="/v_hist_chamado">   Historico</a>
                            </li>
                            <li>
                    ...
                    <?php if(Auth::user()->nivel == 2 and 6): ?>
                    <li>
        ...
        <?php echo Html::script('js/jquery-3.3.1.js'); ?>
        ...
        <?php echo Html::script('js/mdb.js'); ?>

        <?php echo Html::script('js/jquery/jquery.min.js'); ?>

        <?php echo Html::script('js/dropdown.js'); ?>


        <!-- Bootstrap Core JavaScript -->
        <?php echo Html::script('js/bootstrap/js/bootstrap.min.js'); ?>


        <!-- Metis Menu Plugin JavaScript -->
        <?php echo Html::script('js/metisMenu/metisMenu.min.js'); ?>


        <!-- Morris Charts JavaScript -->
        <?php echo Html::script('js/raphael/raphael.min.js'); ?>

        <?php echo Html::script('js/morrisjs/morris.min.js'); ?>

        <?php echo Html::script('js/data/morris-data.js'); ?>
        ...
        <?php echo Html::script('js/buttons.dataTables.min.js'); ?>

        <?php echo Html::script('js/dataTables.editor.min.js'); ?>

        <!-- <?php echo Html::script('../js/dataTables.buttons.min.js'); ?>

         <?php echo Html::script('../js/dataTables.select.min.js'); ?>-->
        ...
        <?php echo Html::script('../formularios/charts/charts_solicitacoes.js'); ?>

        <!-- <?php echo Html::script('../js/buttons.html5.min.js'); ?> -->
        <?php echo Html::script('../js/raphael/raphael.js'); ?>
